...
class AdminAPI:
    ...
    def _get_connections(self):
        ...
        return {"active": 0, "by_client": {}, "total_connected": 0}
    ...
    def _query_messages(self):
        ...
        messages = self.message_store.get_messages(
            to_client=to_client, from_client=from_client, msg_type=msg_type, limit=limit
        )
    ...
    def _get_statistics(self):
        ...
        if self.auth_manager:
            stats["auth"] = {
                ...
                "active_keys": sum(
                    1 for k in self.auth_manager.keys.values() if k.get("active", True)
                ),
            }
