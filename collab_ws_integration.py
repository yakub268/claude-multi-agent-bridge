...
class CollabWSBridge:
    ...
    def _create_room(self, client_id: str, message: Dict) -> Dict:
        ...
        return {"status": "success", "room_id": room_id, "topic": topic}
    ...
    def _send_message(self, client_id: str, message: Dict) -> Dict:
        ...
        room_msg = room.send_message(
            client_id, text, reply_to=reply_to, channel=channel
        )
    ...
    def _upload_file(self, client_id: str, message: Dict) -> Dict:
        ...
        file_id = room.upload_file(
            client_id, file_name, file_content, content_type, channel
        )

        return {"status": "success", "file_id": file_id, "size": len(file_content)}
    ...
    def _propose_decision(self, client_id: str, message: Dict) -> Dict:
        ...
        decision_id = room.propose_decision(client_id, text, vote_type, required_votes)
    ...
    def _list_rooms(self) -> Dict:
        """List all rooms"""
        return {"status": "success", "rooms": self.hub.list_rooms()}
    ...
    def _get_summary(self, message: Dict) -> Dict:
        ...
        return {"status": "success", "summary": room.get_summary()}
    ...
    def _send_critique(self, client_id: str, message: Dict) -> Dict:
        ...
        critique_msg = room.send_critique(
            client_id, target_message_id, critique_text, severity, channel
        )
    ...
    def _propose_alternative(self, client_id: str, message: Dict) -> Dict:
        ...
        if vote_type_str:
            try:
                ...
                return {
                    "status": "error",
                    "error": f"Invalid vote_type: {vote_type_str}",
                }

        alt_id = room.propose_alternative(
            client_id, original_decision_id, alternative_text, vote_type, channel
        )

        return {"status": "success", "alternative_id": alt_id}
    ...
    def _add_debate_argument(self, client_id: str, message: Dict) -> Dict:
        ...
        arg_id = room.add_debate_argument(
            client_id, decision_id, position, argument_text, evidence
        )

        return {"status": "success", "argument_id": arg_id}
    ...
    def _propose_amendment(self, client_id: str, message: Dict) -> Dict:
        ...
        amend_id = room.propose_amendment(client_id, decision_id, amendment_text)

        return {"status": "success", "amendment_id": amend_id}
...
class CollabRoomClient:
    ...
    def join_room(self, room_id: str, role: str = "participant"):
        """Join existing room"""
        response = self.ws.send_collab(
            {"action": "join_room", "room_id": room_id, "role": role}
        )
