...
class HealthCheckManager:
    ...
    def register_routes(self, app):
        ...
        def startup_probe():
            ...
            return jsonify(
                {"status": "started" if started else "starting", "uptime": uptime}
        ...
        def health_status():
            ...
            return jsonify(
                {"status": overall_status, "liveness": liveness, "readiness": readiness}
            )
...
if __name__ == "__main__":
    ...
    health.add_liveness_check(
        HealthCheck(
            name="application_state", check_func=check_application_state, critical=True
        )
    )
    ...
    health.add_readiness_check(
        HealthCheck(
            name="external_service", check_func=check_external_service, critical=True
        )
    )
